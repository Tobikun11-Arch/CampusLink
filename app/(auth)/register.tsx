...
export default function RegisterScreen() {
  ...
  return (
    <View className="flex-1 bg-white px-7 py-10">
      <ScrollView
        ...
        <View className="flex-1 justify-center">
          ...
          <View className="flex-row gap-3">
            <View className="flex-1">
              <Text className="text-[10px] text-gray-500 mb-2 mt-3">
                FIRST NAME
              </Text>
              <TextInput
          ...
          <Text className="text-gray-400 text-xs mt-2">
            Use your official university email and get verification code.
          </Text>
          <Text className="text-[10px] text-gray-500 mb-2 mt-3">
            CREATE PASSWORD
          </Text>
          ...
          <View className="rounded-2xl bg-gray-50 overflow-hidden">
            ...
            >
              ...
              <Picker.Item label="Indang (Main Campus)" value="Indang" />
              <Picker.Item
                label="Trece Martires City Campus"
                value="Trece Martires"
              />
              <Picker.Item label="Imus City Campus" value="Imus" />
              <Picker.Item label="Bacoor City Campus" value="Bacoor" />
              <Picker.Item label="General Trias Campus" value="General Trias" />
              <Picker.Item label="Silang Campus" value="Silang" />
              <Picker.Item label="Carmona Campus" value="Carmona" />
              <Picker.Item label="Naic Campus" value="Naic" />
              <Picker.Item label="Tanza Campus" value="Tanza" />
              <Picker.Item label="Rosario Campus" value="Rosario" />
            </Picker>
          </View>
          ...
          {requiresProof ? (
            <View className="mt-4">
              ...
              >
                ...
                <Text className="mt-3 text-gray-900 font-bold">
                  Upload Document
                </Text>
                ...
                >
                  ...
                  >
                    ...
                    <Text className="text-gray-600 mt-2">
                      Officers and class presidents must upload proof so we can
                      verify your role before granting role-based access.
                    </Text>
                    <Pressable
